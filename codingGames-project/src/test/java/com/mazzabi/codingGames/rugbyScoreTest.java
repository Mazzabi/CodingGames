...
public class rugbyScoreTest {
	...
	public void getCombinaisonOfZeroTest() {
		int score = 0;
		List<String> expectedCombinaisons = Arrays.asList("0 0 0");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}

	@Test
	public void getCombinaisonOfOnlyTry() {
		int score = 5;
		List<String> expectedCombinaisons = Arrays.asList("1 0 0");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}
	...
	public void getCombinaisonOfOnlyTryWithTransformation() {
		int score = 7;
		List<String> expectedCombinaisons = Arrays.asList("1 1 0");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}
	...
	public void getCombinaisonOfOnlyTwoTryWithTransformation() {
		int score = 12;
		List<String> expectedCombinaisons = Arrays.asList("2 1 0", "0 0 4");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}
	...
	public void getCombinaisonOfOnlyTwoTryWithTwoTransformation() {
		int score = 14;
		List<String> expectedCombinaisons = Arrays.asList("2 2 0", "1 0 3");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}
	...
	public void getCombinaisonOfOnlyTryWithNoTransformationWithPenalty() {
		int score = 8;
		List<String> expectedCombinaisons = Arrays.asList("1 0 1");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}
	...
	public void getCombinaisonOfOnlyTryWithNoTransformationWithTwoPenalty() {
		int score = 11;
		List<String> expectedCombinaisons = Arrays.asList("1 0 2");
		List<String> possibleCombinaisons = rugbyScore.getPossibleCombinaisons(score);
		assertEquals(possibleCombinaisons.size(),expectedCombinaisons.size());
		assertTrue(possibleCombinaisons.containsAll(expectedCombinaisons));
	}
	...
	public void getCombinaisonOfBigSocre() {
		int score = 88;
		List<String> expectedCombinaisons = Arrays.asList("1 1 27", "2 0 26", "3 2 23", "4 1 22", "4 4 20", "5 0 21", "5 3 19",
